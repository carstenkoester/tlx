...
class Crossfader : public MasterNotifyClient
{
    public:
    ...
    // friend engine
        ...
        static void createMainXY(Engine& engine);

        void cueHasChanged(Cue::CueSignalType type, Cue* cue);
    ...
    private:
        ...
        Scene* m_p_scene_x;           // Pointer to X scene. If our associated cue has no scene, this shall be the empty scene.
        Scene* m_p_scene_y;           // As above.
